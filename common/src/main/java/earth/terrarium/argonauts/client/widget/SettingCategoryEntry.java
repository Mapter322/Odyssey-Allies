...
public class SettingCategoryEntry extends Button {
    ...
    public SettingCategoryEntry(Font font, Component label, Supplier<Boolean> expanded, Supplier<TriState> value,
                                Runnable onToggle, Consumer<TriState> onApply, boolean editable) {
        this.font = font;
        this.label = label;
    ...
    public void onClick(double mouseX, double mouseY) {
        if (this.onApply != null && this.editable && mouseX >= this.getX() + this.getWidth() - OPTIONS_WIDTH - 3) {
